...
/**
 *  MethodofdistributionSaveRetrieve Class. This class inherits from the base class BaseSaveRetrieve and implements
 *  the BaseSaveRetrieve Interface via the BaseSaveRetrieve class. The primary purpose of this class 
 *  is to act as the the database access layer for the Methodofdistribution Entity. The methods on the BaseSaveRetrieve 
 *  Class and BaseSaveRetrieve Interface are extend in this class for the specific needs of the Methodofdistribution entity.
 ...
 *  several NamedQueries in the Methodofdistribution Class.
 * 
 * @author Lee Baker
 * @version 1.0
 */
